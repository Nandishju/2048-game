      ...
      >
        ...
        2048 is an easy and fun puzzle game.
         Even if you don't love numbers you will love this game.
          It is played on a 4x4 grid using the arrows &uarr;, &darr;,&larr;,&rarr;
          Every time you press a arrow - all tiles slide. Tiles with the same value that bump into one-another are merged. 
